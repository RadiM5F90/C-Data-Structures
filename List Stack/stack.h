 ...
 * implemented through a linked list with a configurable max capacity
 *
 * The stack manages its elements with the LIFO syntax (Last In, First Out),
 * limiting the max number of elements with a capacity set when creating it
 *
